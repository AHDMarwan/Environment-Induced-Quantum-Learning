...
The theory proceeds from the most constrained inverse problem to progressively richer ones.  We first establish binary decoder identifiability and its failure modes, then treat multiclass records where pairwise observations generally recover only a discriminant subspace.  We next analyze how redundancy and spectrum-broadcast geometry condition these inverse problems, before separating passive readout identification from the stronger task of assigning system-specific semantics through intervention.

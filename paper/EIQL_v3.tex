...
\input{sections/01_core_theory}
\input{sections/02_robust_finite_protocol}
\input{sections/03_numerical_benchmarks}
\input{sections/04_positioning_limits_conclusion}
\input{sections/05_appendix_reproducibility_bibliography}
